...
//        select_pose_btn = (Button) findViewById(R.id.select_pose_btn);
        ...
        // 운동 종류 입력
        adapter.addItem(new ExerciseItem("버피 테스트"));
        adapter.addItem(new ExerciseItem("플랭크"));
        adapter.addItem(new ExerciseItem("굿모닝"));
        adapter.addItem(new ExerciseItem("푸쉬업"));
        adapter.addItem(new ExerciseItem("니푸쉬업"));
        adapter.addItem(new ExerciseItem("Y-Exercise"));
