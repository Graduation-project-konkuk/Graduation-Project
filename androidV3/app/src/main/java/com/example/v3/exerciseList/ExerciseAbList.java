...
//        select_pose_btn = (Button) findViewById(R.id.select_pose_btn);
        ...
        // 운동 종류 입력
        adapter.addItem(new ExerciseItem("스탠딩 사이드 크런치"));
        adapter.addItem(new ExerciseItem("스탠딩 니업"));
        adapter.addItem(new ExerciseItem("라잉 레그 레이즈"));
        adapter.addItem(new ExerciseItem("바이시클 크런치"));
        adapter.addItem(new ExerciseItem("크런치"));
